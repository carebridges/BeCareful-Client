...
import { SOCAILWORKER_STEP_CONFIG } from '@/constants/tour';

export const SocialworkerTourTooltip = ({
  index,
  step,
}: TooltipRenderProps) => {
  const config =
    SOCAILWORKER_STEP_CONFIG[index as keyof typeof SOCAILWORKER_STEP_CONFIG] ||
    SOCAILWORKER_STEP_CONFIG[1];
