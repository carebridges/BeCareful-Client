...
import { InstitutionFormData } from '@repo/common';
import { InstitutionRegisterNameInput } from './Step1InstitutionName/InstitutionRegisterNameInput';
import { InstitutionCodeInput } from './Step1InstitutionName/InstitutionCodeInput';
