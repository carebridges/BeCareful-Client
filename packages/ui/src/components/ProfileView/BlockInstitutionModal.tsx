...
interface BlockInstitutionModalProps {
  width: string;
  onClose: () => void;
  onCancel?: () => void;
  onConfirm: () => void;
...
export const BlockInstitutionModal = ({
  width,
  onClose,
  onCancel,
  onConfirm,
}: BlockInstitutionModalProps) => {
  return (
    <Overlay>
      <ModalContent width={width}>
        ...
        <ModalMiddleContainer>
          <span>이 사용자를 차단하시겠습니까?</span>
          <span className="highlight">
            기관 내 모든 담당자에게 차단이 적용되며,
            <br />
            서로의 게시글과 채팅을 볼 수 없습니다.
          </span>
        </ModalMiddleContainer>
