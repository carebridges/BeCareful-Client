...
import ArrowRightCircle from '@repo/ui/src/assets/icons/caregiver/home/ArrowRightCircle.svg';
import { useJoinStatusModal } from '@/hooks/CommunityJoin/useJoinStatusModal';
import { Modal, ModalLimit } from '@repo/ui';
...
export const HomeMainContent = () => {
  ...
  const handleCreateClick = () => {
    router.push('/community/signup');
    // router.push('/community/signup', { scroll: true });
  };

  const handleJoinClick = () => {
    router.push('/community/members/new');
  };
