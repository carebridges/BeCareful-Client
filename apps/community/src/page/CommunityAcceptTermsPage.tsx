...
import { useJoinAssociation } from '@/api/association';
...
import { useCommunityAgree } from '@/hooks/CommunityJoin/useCommunityAgree';
import {
  AssociationRank,
...
export const CommunityAcceptTermsPage = () => {
  ...
  const handleSuccessModalClose = () => {
    ...
    window.location.href = '/community'; // TODO /community 이동
  };
