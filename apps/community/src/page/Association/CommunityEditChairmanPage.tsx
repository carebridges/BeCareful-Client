...
import { useDelegateChairman } from '@/api/association';
import { useHandleNavigate } from '@/hooks/useHandleNavigate';
import CommunityMemberSearch from '@/page/Association/CommunityMemberSearch';
import { ChairmanDelegateRequest } from '@/types/association';
import { ASSOCIATION_MEMBER_TYPES, ASSOCIATION_RANK_MAP } from '@repo/common';
