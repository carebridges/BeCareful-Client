...
import Close from '@repo/ui/src/assets/icons/Close.svg';
import Store from '@repo/ui/src/assets/icons/community/Store.svg';
import Post from '@repo/ui/src/assets/icons/community/Post.svg';
import ChevronDown from '@repo/ui/src/assets/icons/community/ChevronDown.svg';
import PhotoIcon from '@repo/ui/src/assets/icons/community/Photo.svg';
import FileIcon from '@repo/ui/src/assets/icons/community/File.svg';
import LinkIcon from '@repo/ui/src/assets/icons/community/LinkIcon.svg';
import Check from '@repo/ui/src/assets/icons/matching/CircleCheck.svg';
import Delete from '@repo/ui/src/assets/icons/CloseCircle.svg';
import { BOARD_MAP, COMMUNITY_BOARDS_LIST } from '@/constants/community';
import { useHandleNavigate } from '@/hooks/useHandleNavigate';
import { useBoardSelection } from '@/hooks/WritePage/useBoardSelection';
import { useModals } from '@/hooks/WritePage/useModals';
import { usePostings } from '@/hooks/WritePage/usePostings';
import { useMedia } from '@/hooks/WritePage/useMedia';
import { useSave } from '@/hooks/WritePage/useSave';
import { usePostingSubmit } from '@/hooks/WritePage/usePostingSubmit';
...
const CommunityWritePage = () => {
  ...
  const boardTypeParam = params?.boardType as string | undefined;
  ...
  const { handlePostSubmit, handleEditSubmit } = usePostingSubmit(
    board,
    () => handleNavigate('/community'), // TODO /community 이동
    isEditMode,
    postId,
  );
    ...
    <Container>
      ...
      >
        <ModalButtons
          ...
          handleRightBtnClick={() => handleNavigate('/community')} // TODO /community 이동
        />
      </Modal>
