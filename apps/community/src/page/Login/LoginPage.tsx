...
import IconClose from '@repo/ui/src/assets/icons/IconClose.svg';
import LogoBlue from '@repo/ui/src/assets/icons/LogoBlue.svg';
import CheckBox from '@repo/ui/src/assets/icons/SquareCheck.svg';
import { useState } from 'react';
import { useHandleNavigate } from '@/hooks/useHandleNavigate';
import { useIsIOS } from '@repo/common';
import { Button, InputBox, KakaoButton } from '@repo/ui';
      ...
      <LoginContainer>
        ...
        <Description>
          ...
          <div
            ...
            onClick={() => handleNavigate('/signup/kakao')}
          >
            회원가입
          </div>
        </Description>
