...
import { ReactComponent as CareerIcon } from '@repo/ui/src/assets/icons/caregiver/my/Career.svg';
import CareerDetailItem from '@/components/Caregiver/Mypage/CareerDetailItem';
